							...
							<div className="row">
								<div className="col-lg-12 mx-auto">
									<div className="input-group mb-3 px-2 py-1 bg-white file-upload-bdr">
										...
										/>
										<label id="upload-label" for="upload" className="font-weight-light text-muted">
											Add Profile Image
										</label>
									...
									<p className="error font-size-12">
										Please use image with size less than 3 MB and dimensions 1x1 ratio (200 x 200
										Pixels)
									</p>
										...
										<div className="profile-area">
											<div className="form-group text-right">
												<Link to="/edit/profile">
													<button type="button" className="btn btn-profile waves-effect waves-light">
														Edit Profile
													</button>
												</Link>
											</div>
                                    ...
                                    {userData.fees != 0
                                      ...
                                      : "Add question price here"}
															...
															<p className="mt-2 user-profile">
																...
																{userData.publicUrl ? userData.publicUrl : 'Your Public URL will come here'}
															</p>
														</div>
													</div>
												</div>
											...
											<div className="profile-data">
												...
												{userData.about ? (
													...
													<h6>
														Please <Link to="/edit/profile"> click </Link> here to add information
													</h6>
												)}
											</div>
											...
											<div className="profile-data">
												<div className="row">
													<div className="col-md-3">
														<div className="social-link" data-toggle="modal" data-target="#website">
													...
													<div className="col-md-3">
														<div className="social-link" data-toggle="modal" data-target="#facebook">
													...
													<div className="col-md-3">
														<div className="social-link" data-toggle="modal" data-target="#linkedin">
															<i className="fa fa-address-book" aria-hidden="true"></i>
															<br />
															Add Linkedin
														</div>
													...
													<div className="col-md-3">
														<div className="social-link" data-toggle="modal" data-target="#twitter">
															<i className="fa fa-address-book" aria-hidden="true"></i>
															<br />
															Add Twitter
														</div>
